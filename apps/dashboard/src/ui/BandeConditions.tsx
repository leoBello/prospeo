 ...
 *
 * Elle ne porte que la moitié « worker ». La maquette y montre aussi le
 * compte d'envoi Gmail et le compteur d'envois du jour : ils arrivent avec la
 * connexion Google. On ne les esquisse pas en attendant — un emplacement
